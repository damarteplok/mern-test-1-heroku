...
const ResourceForm = ({onFormSubmit, initialData}) => {
    ...
    return (
        <div className="resource-form">
            <h1 className="title">Create Resources</h1>
            <form>
                <div className="field">
                ...
                <div className="field">
                    ...
                    <div className="control">
                                        <textarea
                                            ...
                                            name="description"
                                            className="textarea"
                                            placeholder="Description bla bla bla..."></textarea>
                    </div>
                </div>
                <div className="field">
                    ...
                    <div className="control">
                        <input
                            ...
                            name="link"
                            value={form.link}
                            className="input" type="text" placeholder="https://academy.com" />
                    </div>
                </div>
                <div className="field">
                ...
                <div className="field">
                    ...
                    <div className="control">
                        <input
                            ...
                            onChange={handleChange}
                            name="timeToFinish"
                            className="input" type="number" placeholder="60 (time in minutes)" />
                    </div>
